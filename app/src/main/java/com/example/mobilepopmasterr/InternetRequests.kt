...
// TODO -> maybe rewrite this to use Retrofit instead of OkHttp https://developer.android.com/codelabs/basic-android-kotlin-compose-getting-data-internet#1
// TODO: .env!!!!!!!! .env!!!!
val baseUrl = "https://mobilepopmasterrpyback-194694347863.europe-west1.run.app"
...
suspend fun getRectangleAndPopulation(): Pair<Rectangle, String?> = withContext(Dispatchers.IO) {
    ...
    client.newCall(request).execute().use { response ->
        ...
        val result = if (responseBody != null) {
            ...
            val population = jsonObject.optString("population", null)
            ...
            Pair(Rectangle(LatLng(0.0, 0.0), LatLng(0.0, 0.0)), null)
        }
